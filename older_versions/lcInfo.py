#!/usr/bin/python2.7
"lcOffsets.py --  Identify offsets between lcheapo file segments."
...
def getOptions():
    ...
    usageStr = """%prog [-h] [-v] OBSfile1 OBSfile2 OBSfile3 ...
    	Identifies offsets between LCHEAPO file segments, suggests input for lcSplice:
    		The first file should have a valid header (not necessarily directory
    		The subsequent files should be in chronological order (will indicate if they are not)
"""
