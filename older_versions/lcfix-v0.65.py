...
# Notes       : none
##############################################################################
def makeProcessStepsFile(startTimeStr,parameters,inFiles,outFiles,msgs,returnCode,debug=False) :
  application={
    'name':"lcFix.py",
  ...
  execution['parameters']['input_files']=inFiles
...
##############################################################################
def processInputFile(ifp1, fname, outFileRoot, lcHeader, 
